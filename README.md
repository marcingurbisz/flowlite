...
- Backend HTML report: `build/reports/jacoco/test/html/index.html`
- Backend XML report: `build/reports/jacoco/test/jacocoTestReport.xml`
- Frontend Playwright HTML report: `build/reports/playwright/frontend-coverage/index.html`
- Frontend Playwright LCOV report: `build/reports/playwright/frontend-coverage/lcov.info`
